...
1.  [Deep Learning](http://www.deeplearningbook.org/) by Yoshua Bengio, Ian Goodfellow and Aaron Courville  
2. [Machine Learning - A Probabilistic Perspective](https://doc.lagout.org/science/Artificial%20Intelligence/Machine%20learning/Machine%20Learning_%20A%20Probabilistic%20Perspective%20%5BMurphy%202012-08-24%5D.pdf) by Kevin Murphy (takes you from very basics of Probability to Modern State of Art methods in ML)
...
4. [Cognitive Modeling](http://books.ranvier.ir/download.php?file=Cognitive_Model%20Thad%20A.%20Polk%20Colleen%20M.Seifert.pdf) by Thad A. Polk and Colleen M. Seifert.
5. [The Information Theory, Pattern Recognition, and Neural Networks Lecture Series](https://www.youtube.com/watch?v=BCiZc0n6COY&list=PLruBu5BI5n4aFpG32iMbdWoRVAA-Vcso6) by David MackKay (gives essence of Bayesian Inference and how it connects with Neural Networks).
6. [Information Theory, Inference, and Learning Algorithms](http://www.inference.org.uk/itprnn/book.pdf) by David J.C. MacKay (this is the course book for above mentioned lecture series, Do Read!).
7. [Christopher Olah's Blog](https://colah.github.io/) - Nicely explained concepts and many exciting things!
